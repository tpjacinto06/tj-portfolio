...
export default function Portfolio() {
  ...
  useEffect(() => {
    ...
    link.href = 'https://fonts.cdnfonts.com/css/portrait';
    link.rel = 'stylesheet';
    document.head.appendChild(link);
    
    // Apply font to body
    document.body.style.fontFamily = "'Portrait', sans-serif";
  ...
  if (showInquire) {
    return (
      <div className="min-h-screen bg-white" style={{ fontFamily: "'Portrait', sans-serif" }}>
        {/* Navigation */}
